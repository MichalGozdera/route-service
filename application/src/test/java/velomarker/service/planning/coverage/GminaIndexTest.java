...
/**
 * GminaIndex po refaktorze trzyma heurystyki seeda: {@code samplePointsFor} (czysta geometria, bez coverage)
...
class GminaIndexTest {
    ...
    void distToRoute_small_whenRouteThroughCorner() {
        ...
        GminaIndex idx = new GminaIndex(List.of(g), coverage, null);
