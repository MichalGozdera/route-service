...
public record UnvisitedArea(
    ...
    public UnvisitedArea(int areaId, String name,  double lat, double lng,
                         double[][] ring, int countryId, int levelId, String levelName, Integer specialGroupId) {
        this(areaId, name, lat, lng,
    ...
    public static UnvisitedArea levelMulti(int areaId, String name,  double lat, double lng,
        ...
        return new UnvisitedArea(areaId, name, lat, lng, parts, countryId, levelId, levelName, null);
    }

    /** Obszar specjalny (z grupy specjalnej) z pełną geometrią. */
    public static UnvisitedArea special(int areaId, String name, double lat, double lng,
                                        List<AreaPart> parts, int countryId, String groupName, int specialGroupId) {
        return new UnvisitedArea(areaId, name,  lat, lng, parts, countryId, 0, groupName, specialGroupId);
    }
